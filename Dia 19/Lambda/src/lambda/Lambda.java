...
public class Lambda {
    ...
    public static void main(String[] args) {
        ...
        //pues se definen en linea donde se vayan a utilizar. Dichas funciones pueden recibir creo o
        //más argumentos y devolver uno o ningún valor de retorno.
        
        //Sintáxis
        //(parámetros) -> {cuerpo de la función}
        /*/
        Parámetros: son los alores de entrada de la función.
        ...
        */
        ...
        //Esta interfaz no toma ningún argumento y produce un resultado de tipo T. Es decir, se utiliza cuando se necesita generar o proporcionar un valor, pero no se tiene 
        //ningún argumento para hacerlo. Se puede pensar en ello como una fábrica que suministra datos.
